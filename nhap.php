...
<head>
  ...
  window.onclick = function(event) {
    ...
    if (event.target == document.getElementById('submiteditpost')){
  ...
  function addpostz(){
        ...
        var Post_Des = document.getElementById("Post_Des").value;
  ...
  <div class="container" >
    ...
    <form  method="post" name="regform" onsubmit="return false;" id="regform" enctype="multipart/form-data">
        ...
        <div class="form-group row">
          ...
          <input id="addpost" class="btn btn-success btn-block " type="button"  name="submitadd1" value="Confirm">
